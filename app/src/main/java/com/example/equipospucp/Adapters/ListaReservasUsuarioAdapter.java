        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot children : snapshot.getChildren()){
                    ...
                    if (image.getDispositivo().equals(reservaDto.getReserva().getIddispositivo())){
                        //imageRef = storageReference.child("img/"+image.getImagen());
                        Log.d("ruta", "img/"+image.getImagen());
                        Glide.with(getContext()).load(storageReference.child("img/"+image.getImagen())).into(holder.idImagenDispositivoReservas);
                        break;
                    }
                }
            }
